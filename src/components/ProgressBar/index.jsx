...
import { Card, Col, Container, Row, ProgressBar as BarProgress, Form, Button } from "react-bootstrap"
        ...
        <Row className="mt-5">
            ...
            <Card style={{width:"40rem"}} className="m-auto">
                <Card.Body>
                    ...
                    <Form.Control ref={inputRef} placeholder="Ingresar Porcentaje" className="my-3">
